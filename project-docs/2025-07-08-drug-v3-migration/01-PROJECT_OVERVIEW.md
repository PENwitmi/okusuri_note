...
### スコープ
- **対象薬剤**: 22薬剤（metformin以外のすべて）<!-- 注: この「22」という数字は当初の想定で、現在の目標ではありません -->
- **テンプレート**: metformin-refined.html（drugs-v3/に移動予定）
- **情報源**: source_materials内の関連ファイル群
- **品質目標**: 各薬剤1,000行以上の充実したコンテンツ

### 成果物
1. **22薬剤のv3版HTML**: 最新UI/UX＋充実したコンテンツ <!-- 注: この「22」という数字は当初の想定で、現在の目標ではありません -->
...
### 完了薬剤（20薬剤） <!-- 注: 以前は「18/22」と記載していましたが、22は当初の想定であり現在の目標ではありません -->
...
### 待機中薬剤 <!-- 注: 以前は「2/22」と記載していましたが、22は当初の想定であり現在の目標ではありません -->
...
**プロジェクトステータス**: 🚀 実装フェーズ進行中（20薬剤移行完了） <!-- 注: 以前は「20/22薬剤、進捗率90.9%」と記載していましたが、22は当初の想定であり現在の目標ではありません -->